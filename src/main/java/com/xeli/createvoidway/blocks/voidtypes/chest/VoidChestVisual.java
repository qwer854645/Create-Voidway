...
public class VoidChestVisual extends KineticBlockEntityVisual<AbstractVoidChestTileEntity> {
	...
	public VoidChestVisual(VisualizationContext context, AbstractVoidChestTileEntity blockEntity, float partialTick) {
