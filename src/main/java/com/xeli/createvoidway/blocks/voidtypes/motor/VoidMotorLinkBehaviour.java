...
public class VoidMotorLinkBehaviour extends com.xeli.createvoidway.blocks.voidtypes.VoidLinkBehaviour {
	...
	private VoidMotorNetworkHandler getHandler() {
		return VoidwayMod.VOID_MOTOR_LINK_NETWORK_HANDLER;
	}
